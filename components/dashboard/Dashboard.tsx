...
const allTools = [
  ...
  { icon: <StudentReportsIcon className="h-6 w-6 text-manglar-green"/>, title: 'Informes Estudiantiles', description: 'Elabora informes detallados del progreso académico con análisis de fortalezas, áreas de...', category: 'Evaluación' },
